...
using NotificationsAndMessaging.MobileMaui.Services;
using System;
...
namespace NotificationsAndMessaging.MobileMaui.Platforms.Android.Helpers
{
    internal static class NotificationHelpers
    {
        ...
        public static void RaiseSystemNotificationWhileInForeground(NotificationMessage message)
        {
            ...
            notificationBuilder.SetContentTitle(message.Title)
                        .SetSmallIcon(NotificationsAndMessaging.MobileMaui.Resource.Drawable.ic_mtrl_checked_circle)
